...
def evaluate_hybrid_detector(X_test: pd.DataFrame, y_test: pd.Series) -> Dict[str, Any]:
    ...
    for _, row in X_test.iterrows():
        result = detect_ddos(row.to_dict())
...
def main():
    ...
    print_block("CLASSIFIER EVALUATION")
    ...
    print_block("ANOMALY MODEL EVALUATION")
    ...
    print_block("HYBRID DETECTOR EVALUATION")
    ...
    print("\nDone.")
    print("Use the HYBRID DETECTOR metrics in your presentation.")
